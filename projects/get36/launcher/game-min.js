...
var __extends = this.__extends || function(b, e) {
	...
	gameOverPanel = function(b) {
		...
		e.prototype.showText = function() {
			...
			this.txt1.text = "You have completed " + Data.score + " 36";

			25 > Data.score ? (this.txt2.text = "Come on Baby", this.scorePanel.texture = this.res.getTexture("result4"), this.sharePanel.texture = this.res.getTexture("share4"), this.againPanel.texture = this.res.getTexture("again4")) : 25 <= Data.score && 35 > Data.score ?
				(this.txt2.text = "Your math is not bad", this.scorePanel.texture = this.res.getTexture("result3"), this.sharePanel.texture = this.res.getTexture("share3"), this.againPanel.texture = this.res.getTexture("again3")) : 35 <= Data.score && 45 > Data.score ? (this.txt2.text = "Keep practicing", this.scorePanel.texture = this.res.getTexture("result2"), this.sharePanel.texture = this.res.getTexture("share2"), this.againPanel.texture = this.res.getTexture("again2")) :
				45 <= Data.score && (this.txt2.text = "You are the top scorer", this.scorePanel.texture = this.res.getTexture("result1"), this.sharePanel.texture = this.res.getTexture("share1"), this.againPanel.texture = this.res.getTexture("again1"))
		};
...
var __extends = this.__extends || function(b, e) {
	...
	startGamePanel = function(b) {
		...
		e.prototype.draw = function(b) {
			...
			this.txt1.text = "Click the two blocks whose numbers add up to 36 to remove the block";
			this.txt1.textAlign = egret.HorizontalAlign.CENTER;
			this.txt1.y = a + 10;
			this.txt1.x = 0;
			...
			this.txt2.text = "If the blocks fill screen you lose";
			this.txt2.y = a + 100;
			this.txt2.x = 0;
			this.txt2.textAlign = egret.HorizontalAlign.CENTER;
			this.addChild(this.txt1);
...
var __extends = this.__extends || function(b, e) {
	...
	Game = function(b) {
      ...
      console.log("----game Panel----"+this.gameoverPanel);
				// this.share()
				// alert(Data.score);
			};
